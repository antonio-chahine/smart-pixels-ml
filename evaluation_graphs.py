...
csv_path = "/work/submit/anton100/msci-project/smart-pixels-ml/outfile_2ts5000/evaluation_weights.069-t-20802.699-v-19366.330.csv"
...
plt.tight_layout()
plt.savefig('./figures/test_results_visualization.png', dpi=300, bbox_inches='tight')
plt.show()
